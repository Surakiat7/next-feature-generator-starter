...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-full flex-col items-center justify-center overflow-hidden px-6 py-12">
      ...
      <div className="relative z-10 flex max-w-xl flex-col items-center gap-5 text-center">
        <h1
          ref={titleRef}
          className="text-4xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100 sm:text-5xl lg:text-6xl"
        >
          Next Feature Starter
        </h1>
        <p
          ref={descRef}
          className="max-w-md text-sm leading-relaxed text-zinc-500 dark:text-zinc-400"
        >
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 rounded-md border border-zinc-300/80 bg-white/80 px-4 py-2.5 text-sm font-medium text-zinc-700 shadow-sm transition-colors hover:border-zinc-400 hover:text-zinc-900 dark:border-zinc-700/80 dark:bg-zinc-900/80 dark:text-zinc-300 dark:hover:border-zinc-500 dark:hover:text-zinc-100"
        >
